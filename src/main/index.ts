...
ipcMain.on('get-deviceID', (event) => {
  ...
  if (process.platform === 'win32') {
    // Windows: menggunakan wmic untuk mendapatkan UUID
    ...
    // Linux: menggunakan /etc/machine-id atau /var/lib/dbus/machine-id
    ...
    // macOS: menggunakan system_profiler untuk mendapatkan Hardware UUID
    const script = nodeChildProcess.spawn('sh', [
      '-c',
